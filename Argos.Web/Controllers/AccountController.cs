...
namespace Argos.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public JsonResult GetUserData()
        {
            ...
            var path = user.PicturePath ?? URis.NoImage;


            return Json(new { Result = Responses.Success, Name = user.UserName, ImagePath = path });
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                var result = await UserManager.CreateAsync(user, Labels.Config.DefaultPassword);
