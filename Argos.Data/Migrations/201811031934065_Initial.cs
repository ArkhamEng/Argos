    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => new { t.EntityId, t.AddressTypeId })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.EntityId, t.EmailTypeId })
                .ForeignKey("Business.EmailType", t => t.EmailTypeId, cascadeDelete: true)
                .ForeignKey("Business.Entity", t => t.EntityId, cascadeDelete: true)
                .Index(t => new { t.EntityId, t.Email }, unique: true, name: "Unq_Email")
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.EntityId, t.PhoneTypeId })
                .ForeignKey("Business.Entity", t => t.EntityId, cascadeDelete: true)
                .ForeignKey("Business.PhoneType", t => t.PhoneTypeId, cascadeDelete: true)
                .Index(t => new { t.EntityId, t.Phone }, unique: true, name: "Unq_Phone")
            ...
            CreateTable(
                ...
                .ForeignKey("Business.Detail", t => t.DetailId, cascadeDelete: false)
                .ForeignKey("Inventory.FlowDirection", t => t.Direction, cascadeDelete: false)
                .ForeignKey("Inventory.Item", t => t.ItemId, cascadeDelete: false)
                .Index(t => t.ItemId)
                .Index(t => t.DetailId)
                .Index(t => t.Direction);
        ...
        public override void Down()
        {
            ...
            DropIndex("Sales.Client", "Unq_BusinessName");
            DropIndex("Sales.Client", new[] { "EntityId" });
            DropIndex("Purchasing.Supplier", new[] { "Status" });
            DropIndex("Purchasing.Supplier", "Unq_BusinessName");
