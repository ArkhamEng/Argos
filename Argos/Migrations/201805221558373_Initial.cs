    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("Production.Account", t => t.AccountId, cascadeDelete: false)
                .Index(t => t.AccountId);
            ...
            CreateTable(
                ...
                .ForeignKey("Production.AccountType", t => t.AccountTypeId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("Config.Town", t => t.TownId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("Production.Policy", t => t.PolicyId, cascadeDelete: false)
                .ForeignKey("Production.Status", t => t.StatusId, cascadeDelete: false)
                .Index(t => t.PolicyId)
                .Index(t => t.StatusId);
            ...
            CreateTable(
                ...
                .ForeignKey("Operative.OperationType", t => t.OperationType_OperationTypeId)
                .ForeignKey("Operative.Supplier", t => t.SupplierId)
                .Index(t => t.OperationId)
            ...
            CreateTable(
                ...
                .ForeignKey("Operative.OperationType", t => t.TypeId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("Operative.Sale", "TypeId", "Operative.OperationType");
            ...
            DropForeignKey("Operative.Purchase", "OperationType_OperationTypeId", "Operative.OperationType");
            ...
            DropForeignKey("Production.Location", "TownId", "Config.Town");
            ...
            DropForeignKey("BusinessEntity.Address", "TownId", "Config.Town");
            ...
            DropForeignKey("Config.Branch", "TownId", "Config.Town");
            ...
            DropForeignKey("Security.SystemUser", "SystemUserId", "BusinessEntity.Person");
            ...
            DropIndex("Production.Location", new[] { "TownId" });
            ...
            DropIndex("Config.Branch", new[] { "TownId" });
            ...
            DropIndex("BusinessEntity.Address", new[] { "TownId" });
